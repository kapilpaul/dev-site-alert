...
namespace Rt_Dev_Site_Alert\Inc\Traits;
...
trait Singleton {
	...
	final public static function get_instance() {
		...
		if ( ! isset( $instance[ $called_class ] ) ) {
			...
			/**
			 * Dependent items can use the rt_dev_site_alert_singleton_init_{$called_class} hook to execute code
			 */
			do_action( sprintf( 'rt_dev_site_alert_singleton_init_%s', $called_class ) ); // phpcs:ignore WordPress.NamingConventions.ValidHookName.UseUnderscores
