 ...
 *
 * @package rt-dev-site-alert-featuers
 */

namespace Rt_Dev_Site_Alert\Inc\Helpers;
...
function autoloader( $resource = '' ) {
	...
	$resource_path  = false;
	$namespace_root = 'Rt_Dev_Site_Alert\\';
	...
	if ( 'inc' === $path[0] ) {
		...
		$resource_path = sprintf( '%s/inc/%s/%s.php', untrailingslashit( RT_DEV_SITE_ALERT_PATH ), $directory, $file_name );
...
spl_autoload_register( '\Rt_Dev_Site_Alert\Inc\Helpers\autoloader' );
